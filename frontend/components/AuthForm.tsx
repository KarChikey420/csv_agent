...
const AuthForm: React.FC<AuthFormProps> = ({ onAuthSuccess }) => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col lg:flex-row relative overflow-hidden font-sans">
      ...
      <div className="w-full lg:w-[55%] p-8 lg:p-16 xl:p-24 flex flex-col justify-center relative z-10">
        <div className="max-w-2xl mx-auto lg:mx-0">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-bold tracking-wider uppercase mb-8 shadow-lg shadow-primary/10 backdrop-blur-md">
          ...
          <p className="text-muted-foreground text-lg lg:text-xl mb-12 leading-relaxed max-w-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="bg-white/[0.03] backdrop-blur-md border border-white/10 p-6 rounded-2xl hover:bg-white/[0.06] transition-colors duration-300 group">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">Collaborative multi-agent architecture to solve complex data challenges.</p>
            </div>
            
            <div className="bg-white/[0.03] backdrop-blur-md border border-white/10 p-6 rounded-2xl hover:bg-white/[0.06] transition-colors duration-300 group">
              <div className="w-12 h-12 rounded-full bg-accent/20 flex items-center justify-center mb-4 text-accent group-hover:scale-110 transition-transform">
                <Brain className="w-6 h-6" />
              </div>
              <h3 className="font-bold text-white mb-2 text-lg">EDA Reasoning</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">Deep analysis, intelligent outlier detection, and automated insight generation.</p>
            </div>
            ...
            <div className="bg-white/[0.03] backdrop-blur-md border border-white/10 p-6 rounded-2xl hover:bg-white/[0.06] transition-colors duration-300 group">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">Dynamic, on-the-fly plot generation for immediate visual clarity.</p>
            </div>
            ...
            <div className="bg-white/[0.03] backdrop-blur-md border border-white/10 p-6 rounded-2xl hover:bg-white/[0.06] transition-colors duration-300 group">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">RAG-based knowledge retrieval for deep contextual data understanding.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[45%] flex items-center justify-center p-8 lg:p-12 relative z-10 bg-black/20 lg:border-l border-white/5 backdrop-blur-2xl">
        <div className="w-full max-w-[420px] bg-white/[0.02] backdrop-blur-3xl rounded-[2rem] p-10 py-12 border border-white/10 shadow-2xl relative overflow-hidden group">
          ...
          <div className="text-center mb-10 relative z-10">
            <div className="w-16 h-16 bg-gradient-to-br from-primary/20 to-accent/20 rounded-2xl flex items-center justify-center mx-auto mb-6 border border-primary/30 shadow-lg shadow-primary/20 group-hover:scale-105 transition-transform duration-500 primary-glow">
          ...
          <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
            {!isLogin && (
              <div>
                ...
                <div className="relative group/input">
                  <User className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-muted-foreground group-focus-within/input:text-primary transition-colors" />
                  <input
                    type="text"
                    value={formData.name}
                    onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                    className="w-full bg-black/40 text-white pl-12 pr-4 py-3.5 rounded-xl border border-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 focus:outline-none transition-all placeholder-slate-600"
            ...
            <div>
              ...
              <div className="relative group/input">
                <Mail className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-muted-foreground group-focus-within/input:text-primary transition-colors" />
                <input
                  type="email"
            ...
            <div>
              ...
              <div className="relative group/input">
                <Lock className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-muted-foreground group-focus-within/input:text-primary transition-colors" />
                <input
                  type="password"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-primary hover:bg-primary/90 disabled:opacity-50 text-primary-foreground py-4 rounded-xl font-bold text-base transition-all shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/40 active:scale-[0.98] flex items-center justify-center gap-2 mt-8"
            >
              {loading ? (
